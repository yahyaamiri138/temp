...
const Reports = () => {
  ...
  // استایل برای کارت‌ها در حالت راست‌چین
  const cardStyle = isRTL ? { textAlign: "right" as const } : {};
          ...
          >
            <div className="col-12 col-md-4 mb-2 mb-sm-0">
              <Card
                ...
                style={cardStyle}
              >
                <h5 style={cardStyle}>{totalUsers}</h5>
              </Card>
            </div>
            <div className="col-12 col-md-4 mb-2 mb-sm-0">
              <Card
                title={t("reports.adminUsers")}
                className="small-card"
                style={cardStyle}
              >
                <h5 style={cardStyle}>{adminCount}</h5>
              </Card>
            </div>
            <div className="col-12 col-md-4 mb-2 mb-sm-0">
              <Card
                title={t("reports.normalUsers")}
                className="small-card"
                style={cardStyle}
              >
                <h5 style={cardStyle}>{userCount}</h5>
              </Card>
            </div>
          </div>
